<div class="pageHeader">
    <form id="pagerForm" onsubmit="return navTabSearch(this);" action="table-grid.html" method="post">
...
<div class="pageContent">
    <table class="j-table" width="100%" layoutH="95">
        <thead>
            <tr>
                <th></th>
                <th orderField="code">客户号</th>
                <th orderField="name">客户名称</th>
                <th orderField="type">客户类型</th>
                <th orderField="idno">证件号码</th>
                <th orderField="grade">信用等级</th>
                <th orderField="industry">所属行业</th>
                <th class="orderby asc" orderField="date">建档日期</th>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><input type="checkbox" name="ids" class="j-icheck" value="5"></td>
                <td>
                    <a href="form.html" class="btn btn-green btn-sm" target="navTab" rel="form">编辑</a>
                    <a href="ajaxDone3.html" class="btn btn-red btn-sm" target="ajaxTodo" title="确定要删除该行信息吗？">删</a>
                </td>
            </tr>
            <tr>
